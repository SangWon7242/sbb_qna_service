...
public class QuestionService {
  ...
  public Page<Question> getList(String kw, int page) {
    ...
    return this.questionRepository.findDistinctBySubjectContainsOrContentContainsOrAuthor_usernameContainsOrAnswerList_contentContainsOrAnswerList_author_usernameContains (kw, kw, kw, kw, kw, pageable);
  }
