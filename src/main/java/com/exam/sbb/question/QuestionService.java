...
public class QuestionService {
  ...
  public Page<Question> getList(String kw, int page) {
    ...
    return this.questionRepository.findDistinctBySubjectContainsOrContentContainsOrAuthor_usernameContainsOrAnswerList_contentContains(kw, kw, kw, kw, pageable);
  }
